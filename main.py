...
SELECT o.city, o.officeCode, o.phone
FROM offices o
...
SELECT 
    ...
    e.firstName, 
    e.lastName, 
    COUNT(c.customerNumber) AS count_customers
FROM employees e
...
SELECT DISTINCT 
    ...
    e.officeCode
FROM employees e
JOIN offices o_off ON e.officeCode = o_off.officeCode
JOIN customers c ON e.employeeNumber = c.salesRepEmployeeNumber
...
get_ipython().system('jupyter nbconvert --to script SQLJoinsSubQueriesLab.ipynb')
